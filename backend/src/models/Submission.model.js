...
const submissionSchema = new mongoose.Schema(
  {
    ...
    projectDetails: {
      ...
      initiation: {
        ...
        confirmedObjectives: String,
        confirmedExpectedOutcomes: String,
        workPlan: String,
        ...
        status: { type: String, enum: ['PENDING', 'IN_PROGRESS', 'SUBMITTED', 'UNDER REVIEW', 'STARTED'], default: 'PENDING' },
        submittedAt: Date,
        reviewedAt: Date,
        reviewedBy: String
      },
      samples: [{
        ...
        quantity: Number,
        source: String,
        status: { type: String, enum: ['PENDING', 'RECEIVED', 'IN TESTING', 'CONSUMED', 'RETURNED'], default: 'PENDING' },
        remarks: String,
      ...
      testMatrix: [{
        ...
        relatedPhase: { type: mongoose.Schema.Types.ObjectId },
        testObjective: String,
        sampleRef: { type: mongoose.Schema.Types.ObjectId },
        ...
        status: { type: String, enum: ['DRAFT', 'SUBMITTED', 'UNDER REVIEW', 'APPROVED', 'CHANGES REQUIRED', 'SCHEDULED', 'IN PROGRESS', 'COMPLETED'], default: 'DRAFT' },
        remarks: String,
        attachments: [{ filename: String, url: String, mimetype: String, storageProvider: { type: String, default: 'local' }, objectKey: String }]
      }],
      milestones: [{
